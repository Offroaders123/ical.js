...
class Recur {
  ...
  static _stringToData(string, fmtIcal) {
    ...
    for (let i = 0; i < len; i++) {
      ...
      /** @type {keyof typeof partDesign | keyof typeof optionDesign} */
      ...
      if (ucname in partDesign) {
        ...
        for (let part of partArr) {
          partSet.add(partDesign[/** @type {keyof typeof partDesign} */ (ucname)](part));
        }
        partArr = [...partSet];

        dict[name] = (partArr.length == 1 ? partArr[0] : partArr);
      } else if (ucname in optionDesign) {
        optionDesign[/** @type {keyof typeof optionDesign} */ (ucname)](value, dict, fmtIcal);
      } else {
   ...
   *
   * @param {keyof typeof DOW_MAP} string     The iCalendar day name
