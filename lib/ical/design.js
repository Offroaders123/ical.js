...
/**
 * @param {RegExp} fromNewline
 * @param {RegExp} toNewline
 */
function createTextType(fromNewline, toNewline) {
  let result = {
    matches: /.*/,

    fromICAL: function(/** @type {string} */ aValue, /** @type {string} */ structuredEscape) {
      return replaceNewline(aValue, fromNewline, structuredEscape);
    },

    toICAL: function(/** @type {string} */ aValue, /** @type {string} */ structuredEscape) {
      let regEx = toNewline;
      if (structuredEscape)
...
/**
 * @param {string} value
 * @param {RegExp} newline
 * @param {string} structuredEscape
 */
...
let icalProperties = extend(commonProperties, {
  ...
  "rdate": {
    ...
    multiValue: ',',
    detectType: function(/** @type {string} */ string) {
      if (string.indexOf('/') !== -1) {
        return 'period';
      }
...
const vcardValues = extend(commonValues, {
  ...
  date: {
    decorate: function(/** @type {string} */ aValue) {
...
const design = {
   ...
   * @return {design.designSet}      The design set for the component
   */
