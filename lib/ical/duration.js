...
const DATA_PROPS_TO_COPY = /** @type {const} */ (["weeks", "days", "hours", "minutes", "seconds", "isNegative"]);
...
class Duration {
   ...
   *
   * @param {String} string      The raw ical value
 ...
 * @param {Parameters<Duration["fromData"]>[0]} object target to assign values to
 */
function parseDurationChunk(letter, number, object) {
  /** @type {typeof DATA_PROPS_TO_COPY[number]} */
  let type;
  switch (letter) {
    case 'P':
      if (number && number === '-') {
