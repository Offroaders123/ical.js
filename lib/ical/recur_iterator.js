...
class RecurIterator {
  ...
  /**
   * @param {string} aRuleType
   * @param {string} aInterval
   * @param {string} aDateAttr
   * @param {string} aFollowingAttr
   * @param {string} [aPreviousIncr]
   */
  ...
  /**
   * @param {number} inc
   * @param {Exclude<keyof Time, "icaltype">} aDateAttr
   * @param {number} aFactor
   * @param {string} aNextIncrement
   */
   ...
   *
   * @private
   * @param {number} aPos position to check for.
  ...
  /**
   * @param {keyof typeof RecurIterator._indexMap} aRuleType
   */
