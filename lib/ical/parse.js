 ...
 * @param {design.designSet=} designSet
 ...
 * @property {design.designSet} designSet    The design set to use for parsing
 ...
 *
 * @private
 * @function parse._handleContentLine
 * @param {String} line               The content line to process
 * @param {parse.parserState}    The current state of the line parsing
 */
 ...
 * @param {design.designSet} designSet   The design data for this value
 ...
 * @param {function(?String, String): void} callback    The callback for each line
 */
